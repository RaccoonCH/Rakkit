...
describe("Middlewares", () => {
  ...
  beforeAll(async () => {
    ...
    const middleware1: MiddlewareType = async ({}, next) => {
      middlewareLogs.push("middleware1 before");
      const result = await next();
      middlewareLogs.push("middleware1 after");
      return result;
    };
    const middleware2: MiddlewareType = async ({}, next) => {
      middlewareLogs.push("middleware2 before");
      const result = await next();
      middlewareLogs.push("middleware2 after");
      return result;
    };
    const middleware3: MiddlewareType = async ({}, next) => {
      middlewareLogs.push("middleware3 before");
      const result = await next();
      middlewareLogs.push("middleware3 after");
      return result;
    };
    const interceptMiddleware: MiddlewareType = async ({}, next) => {
      const result = await next();
      middlewareLogs.push(result);
      return "interceptMiddleware";
    };
    const returnUndefinedMiddleware: MiddlewareType = async ({}, next) => {
      const result = await next();
      middlewareLogs.push(result);
    };
    const errorCatchMiddleware: MiddlewareType = async ({}, next) => {
      try {
        return await next();
      } catch (err) {
    ...
    class SampleObject {
      ...
      @Field()
      @UseMiddlewareRakkitQL(fieldResolverMiddleware)
    ...
    class SampleResolver {
      ...
      @UseMiddlewareRakkitQL(middleware1, middleware2, middleware3)
      ...
      @UseMiddlewareRakkitQL(middleware1)
      @UseMiddlewareRakkitQL(middleware2)
      @UseMiddlewareRakkitQL(middleware3)
      @Query(returns => String)
      ...
      @Query()
      @UseMiddlewareRakkitQL(interceptMiddleware)
      ...
      @Query()
      @UseMiddlewareRakkitQL(errorCatchMiddleware)
      ...
      @Query()
      @UseMiddlewareRakkitQL(errorThrowAfterMiddleware)
      ...
      @Query()
      @UseMiddlewareRakkitQL(errorThrowMiddleware)
      ...
      @Query()
      @UseMiddlewareRakkitQL(doubleNextMiddleware)
      ...
      @Query()
      @UseMiddlewareRakkitQL(ClassMiddleware)
  ...
  it("should correctly call global middlewares before local ones", async () => {
    const globalMiddleware1: MiddlewareType = async ({}, next) => {
      middlewareLogs.push("globalMiddleware1 before");
      const result = await next();
      middlewareLogs.push("globalMiddleware1 after");
      return result;
    };
    const globalMiddleware2: MiddlewareType = async ({}, next) => {
