import { ensureInstalledCorrectGraphQLPackage } from "../../../../src/modules/rakkitql/src/utils/graphql-version";
import { UnmetGraphQLPeerDependencyError } from "../../../../src/modules/rakkitql";
...
describe("`graphql` package peer dependency", () => {
  ...
  it("should throw error when the installed version doesn't fulfill requirement", async () => {
    ...
    const graphqlVersion = require("../../../../src/modules/rakkitql/src/utils/graphql-version");
